...
import Migration0054 from "./Migrations/054_ThreadMonitors.ts";
import Migration0055 from "./Migrations/055_ThreadMonitorDelivery.ts";
import Migration0056 from "./Migrations/056_ComputerThreadMonitors.ts";
import Migration0057 from "./Migrations/057_ComputerMonitorEvaluationThrottle.ts";
import Migration0058 from "./Migrations/058_AdaptiveComputerMonitors.ts";
import Migration0059 from "./Migrations/059_ComputerMonitorImageEncoding.ts";
import Migration0060 from "./Migrations/060_ProjectionThreadMessageSystemEvents.ts";
import Migration0061 from "./Migrations/061_ComputerMonitorCacheWriteUsage.ts";
import Migration0062 from "./Migrations/062_UserDesktops.ts";
import Migration0063 from "./Migrations/063_UserDesktopAccessAudit.ts";
import Migration0064 from "./Migrations/064_PreviewSessions.ts";
import Migration0065 from "./Migrations/065_ToolRuns.ts";
...
export const migrationEntries = [
  ...
  [52, "ProjectionThreadTitleState", Migration0052],
  [53, "PullRequestFilesViewed", Migration0053],
  [54, "ThreadMonitors", Migration0054],
  [55, "ThreadMonitorDelivery", Migration0055],
  [56, "ComputerThreadMonitors", Migration0056],
  [57, "ComputerMonitorEvaluationThrottle", Migration0057],
  [58, "AdaptiveComputerMonitors", Migration0058],
  [59, "ComputerMonitorImageEncoding", Migration0059],
  [60, "ProjectionThreadMessageSystemEvents", Migration0060],
  [61, "ComputerMonitorCacheWriteUsage", Migration0061],
  [62, "UserDesktops", Migration0062],
  [63, "UserDesktopAccessAudit", Migration0063],
  [64, "PreviewSessions", Migration0064],
  [65, "ToolRuns", Migration0065],
] as const;
