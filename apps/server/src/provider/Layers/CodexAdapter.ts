...
export const makeCodexAdapter = Effect.fn("makeCodexAdapter")(function* (
  ...
  const resolveAttachment = Effect.fn("resolveAttachment")(function* (
    ...
    // Standalone monitor tool output requires image URLs; ordinary user turns
    // use local paths so their requests stay independent of attachment size.
    if (input.inputSource === "harness") {
