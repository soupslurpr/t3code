...
describe("buildCodexApplicationContext", () => {
  ...
  it.each([
  ...
  ])("gates browser and device guidance independently: %j", (availability) => {
    const context = buildCodexApplicationContext(runtime, availability, false);
    ...
    NodeAssert.equal(
      instructions.includes("Do not switch to global browser skills"),
