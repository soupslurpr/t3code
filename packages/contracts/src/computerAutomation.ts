...
export const ComputerAutomationWaitForChangeInput = Schema.Struct({
  ...
  description:
    "Waits until pixels in a current frame-relative region change or the timeout expires, without returning every sampled image.",
});
...
export const ComputerAutomationAction = Schema.Union([
  ...
  Schema.Struct({
    ...
    description: "Wait until a frame-relative image region changes or the timeout expires.",
  }),
]);
